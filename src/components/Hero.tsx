    ...
    <section className="relative bg-primary py-20 md:py-28 lg:py-32 overflow-hidden" role="banner">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <span className="inline-block bg-accent/90 text-white text-sm font-medium px-3 py-1 rounded-full mb-4 animate-fade-in shadow-md">
            A Decade of Excellence in Real Estate 🏡
          </span>
          <h1 className="font-display text-4xl font-bold text-white sm:text-5xl md:text-6xl lg:text-7xl max-w-5xl mx-auto leading-tight animate-fade-in" tabIndex={0}>
            Revolutionizing Real Estate & <span className="text-accent">Community Building</span> in India
          </h1>
          <p className="mt-6 max-w-2xl mx-auto text-lg text-gray-200 sm:text-xl md:mt-5 md:max-w-3xl animate-fade-in delay-150" tabIndex={0}>
          ...
          <div className="mt-10 max-w-xl mx-auto animate-fade-in delay-300">
            <form onSubmit={handleSearch} className="flex items-center bg-white/95 backdrop-blur-md rounded-lg shadow-xl p-2" role="search">
              ...
              <button 
                type="submit"
                className="bg-accent hover:bg-accent/90 text-white px-6 py-2 rounded-md transition-colors btn-hover-effect"
                aria-label="Search properties"
              >
                Search
              </button>
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4 animate-fade-in delay-450">
            <button 
              className="bg-white text-primary px-6 py-3 rounded-md font-medium hover:bg-gray-50 transition-all duration-300 hover:scale-105 shadow-md"
            ...
            <button 
              className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-md font-medium hover:bg-white/10 transition-all duration-300 hover:scale-105"
              onClick={() => document.getElementById('property-form')?.scrollIntoView({ behavior: 'smooth' })}
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 md:gap-16 animate-fade-in delay-600">
            <div className="flex flex-col items-center text-white">
              ...
              <span className="text-gray-200 text-sm md:text-base">Years of Excellence</span>
            </div>
            <div className="flex flex-col items-center text-white">
            ...
            <div className="flex flex-col items-center text-white">
              <span className="font-display font-bold text-3xl md:text-4xl">500+</span>
