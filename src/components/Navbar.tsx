...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-50 shadow-sm border-b sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center h-auto py-4">
          ...
          <div className="flex items-center space-x-4 mt-4 bg-gray-100/80 backdrop-blur-sm rounded-lg px-6 py-3">
            <button onClick={scrollToPropertyForm} className="text-gray-700 hover:text-primary px-3 py-2 rounded-md text-sm font-medium">
            ...
            <button onClick={scrollToPropertyForm} className="bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md text-sm font-medium">
              List Property
            </button>
          </div>
        </div>
