...
export const Statistics = () => {
  ...
  return (
    <section id="statistics-section" className="py-10 sm:py-16 bg-white dark:bg-gray-900 rounded-lg shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-50">Building Trust in Real Estate</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8">
          {stats.map((stat, index) => (
            <motion.div
              key={index}
              className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 sm:p-6 text-center border border-gray-100 dark:border-gray-700 hover:border-primary/30 hover:shadow-md transition-all"
